const translations = {
  en: {
    ...
    "nav.access": "Trial",
    "hero.subtitle": "A simulation-driven embodied data transformation toolchain for model evaluation and human-aligned data synthesis.",
    ...
    "trial.interaction": "Interactive Demo",
